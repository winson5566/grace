    ...
    for (var i = 0; i < array.length; i++) {
        ...
        for (var j in array[0]) {
            if (j == 'data') {
                ...
                str += '<th class="width150 font-white">' + '价格' + '</th>\r\n';
                str += '<th class="width60 font-white">' + '数量' + '</th>\r\n';
                str += '</tr>\r\n';
                var arr = array[i];
                ...
                for (var k = asks.length - 5; k < asks.length; k++) {
                    str += '<tr id="okcoin-btc-sell" class="font-red">\r\n';
                    var ask = asks[k];
                    ...
                    str += '<td id="okcoin-btc-sell-amount-' + (asks.length-k) + '"  class="width60 ">' + ask[1] + '</td>\r\n';
                    str += '</tr>\r\n';
                }
                //买
                for (var k = 0; k < 5; k++) {
                    str += '<tr id="okcoin-btc-buy"  class="font-green">\r\n';
                    var bid = bids[k];
                    ...
                    str += '<td id="okcoin-btc-buy-amount-' + (k+1) + '"  class="width60 ">' + bid[1] + '</td>\r\n';
                    str += '</tr>\r\n';
                }
                str += '</table>\r\n';
                if (channel == 'ok_sub_spotcny_btc_depth_20') {
