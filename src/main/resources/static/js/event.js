...
$("#btc-trade").click(function(){
    ...
    $.ajax({
        ...
        data:{
            autoTradeBtc:btcTrade,autoTradeLtc:ltcTrade,autoThresholdBtc:btcThreshold,autoThresholdLtc:ltcThreshold
        },
        type: 'GET',
        dataType: 'json',
        timeout: 1000,
